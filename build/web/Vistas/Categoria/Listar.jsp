...
<html>
    ...
    <body>
        ...
        <a href="Categorias?accion=AD" class="btn btn-success">
        ...
        <a href="GenerarPDF?tabla=Categorias" class="btn btn-info">
        ...
        <tr>
            ...
            <td>
                ...
                <% }else if(categoria.getEstado_categoria() == 0){ %> 
            ...
            <td>
                <a href="Categorias?accion=E&id=<%=categoria.getId_categoria()%>" class="btn btn-warning">
                ...
                <a href="Categorias?accion=DEL&id=<%=categoria.getId_categoria()%>" class="btn btn-danger">
